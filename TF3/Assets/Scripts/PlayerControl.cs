...
{
    [HideInInspector] public float sens = 0.1f;
    ...
    private float jump_velocity = 5.111651396549759f; // using 268.3281572999747f HU for now
    ...
    void FixedUpdate()
    {
        // rb.rotation = Quaternion.Euler(rb.rotation.eulerAngles + new Vector3(0.0f, rot.x, 0.0f));
